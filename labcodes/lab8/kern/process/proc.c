...
alloc_proc(void) {
    ...
    proc -> yptr = NULL;
    proc -> optr = NULL;
     //LAB6 2016011364 : (update LAB5 steps)
    /*
...
do_fork(uint32_t clone_flags, uintptr_t stack, struct trapframe *tf) {
    ...
    ret = -E_NO_MEM;
    //LAB4:EXERCISE2 2016011364
    //LAB8:EXERCISE2 2016011364  HINT:how to copy the fs in parent's proc_struct?
    /*
